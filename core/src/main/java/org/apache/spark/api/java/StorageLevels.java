...
public class StorageLevels {
  ...
  public static final StorageLevel REDIS = create(false, false, false, true, false, 1);
  ...
  public static StorageLevel create(
    ...
    int replication) {
    return StorageLevel.apply(useDisk, useMemory, useOffHeap, useRedis, deserialized, replication);
  }
}
